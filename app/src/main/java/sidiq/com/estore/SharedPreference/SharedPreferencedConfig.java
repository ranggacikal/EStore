package sidiq.com.estore.SharedPreference;
...
public class SharedPreferencedConfig {
    ...
    public static final String PREFERENCE_ESTORE_APP = "prefEstoreApp";
    ...
    public static final String PREFERENCE_STATUS_MEMBER = "prefStatusMember";
    ...
    public static final String PREFERENCE_NAMA_TOKO_STATUS = "prefNamaTokoStatus";
    ...
    public String getPreferenceStatusMember(){
        return preferences.getString(PREFERENCE_STATUS_MEMBER, "");
    }
    ...
    public  String getPreferenceNamaTokoStatus() {
        return preferences.getString(PREFERENCE_NAMA_TOKO_STATUS, "");
    }
